            ...
            if (tfod != null) {
                    ...
                    if (updatedRecognitions != null)
                    {
                      ...
                      //  telemetry.addData(String.format("Test"));
                        ...
                        telemetry.addData(String.format("label (%d)", discs), recognition.getLabel());
                        telemetry.addData(String.format("  left,top (%d)", discs), "%.03f , %.03f",
                                recognition.getLeft(), recognition.getTop());
                        telemetry.addData(String.format("  right,bottom (%d)", discs), "%.03f , %.03f",
                                recognition.getRight(), recognition.getBottom());
                        telemetry.addData("This many discs:", String.format("label (%d)", discs));
